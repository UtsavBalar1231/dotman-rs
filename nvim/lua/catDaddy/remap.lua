...
vim.api.nvim_set_keymap("n", "<leader>ss", ":w<CR>:source %<CR>", { noremap = true, silent = true })
...
vim.api.nvim_set_keymap("v", "<C-h>", ":noh<CR>", { noremap = true, silent = true })

-- Remap <C-l> to clear search results
vim.api.nvim_set_keymap("n", "<C-l>", ":nohlsearch<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<C-l>", ":nohlsearch<CR>", { noremap = true, silent = true })

-- Suspend with Ctrl-f
vim.api.nvim_set_keymap("n", "<C-f>", ":suspend<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "<C-f>", "<Esc>:suspend<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<C-f>", "<Esc>:suspend<CR>", { noremap = true, silent = true })
...
vim.api.nvim_set_keymap("n", "<leader>o", ':e <C-R>=expand("%:p:h")."/"<CR>', { noremap = true, silent = true })
