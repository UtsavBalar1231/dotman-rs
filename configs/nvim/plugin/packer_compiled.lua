...
_G.packer_plugins = {
  ...
  ["crates.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/crates.nvim",
    url = "https://github.com/Saecki/crates.nvim"
  },
  ["efmls-configs-nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/efmls-configs-nvim",
  ...
  ["lsp-status.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/lsp-status.nvim",
  ...
  ["sphinx.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/sphinx.nvim",
